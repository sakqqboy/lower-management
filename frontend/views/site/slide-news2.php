...
<div class="row">
        <a href="<?= Yii::$app->homeUrl ?>qna">
                <img src="<?= Yii::$app->homeUrl ?>images/logo/earth.gif" class="earth2">
                <div class="text-earth2"><b>Go to map</b></div>
        </a>

        <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center slide-news2">
                <?php carousel::widget([]);
                $total = count($slide);
                                                ...
                                                foreach ($slide as $newsId => $news) : ?>
                                                        ...
                                                        <div class="carousel-item <?= $i == 0 ? 'active' : '' ?> ">
                                                                <a href="<?= Yii::$app->homeUrl ?>news-update/default/news-detail/<?= ModelMaster::encodeParams(["newsId" => $newsId]) ?>" class="news-update-a">
                                                                        <img src="<?= Yii::$app->homeUrl . $news["picture"] ?>" class="d-block w-100-2 w-100">
