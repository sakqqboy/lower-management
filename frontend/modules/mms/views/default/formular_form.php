...
$form = ActiveForm::begin([
	'id' => 'create-job-form',
	'method' => 'post',
	'action' => Yii::$app->homeUrl . 'mms/default/save-chart',
	'options' => [
...
<div class="body-content pt-30" id="create-graph">
	<div class="row">
		<div class="col-12 font-size22 font-weight-bolder" style="padding-left: 70px;">
	...
	<div class="row mt-20">
		<div class="col-lg-6 col-md-6 col-12 mt-10 ">
			...
			<input type="input" class="form-control" placeholder="Graph name" name="title" required id="chart-name">
		</div>
		<div class="col-lg-6 col-md-6 col-12 mt-10 ">
			<label>Country</label>
	...
	<div class="col-12 border mt-10 pt-20 pb-20">
		<input type="radio" name="dataType" value="1" class="mr-10 radio-md" required onchange="javascript:setDataType(1)"> Value
		<input type="radio" name="dataType" value="2" class="mr-10 radio-md ml-20" required onchange="javascript:setDataType(2)"> Percentage
	...
	<div class="row col-12 mt-20" id="fillOut">
		<label>Fill out ammout</label>
	</div>
	<div style="width: 100%;" id="input-formular">
	</div>
</div>
<?php ActiveForm::end(); ?>