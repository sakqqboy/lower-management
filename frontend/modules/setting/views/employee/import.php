...
<div class="body-content pt-20 container">
	<div class="row">
		<div class="col-12 mb-20 ">
			<span class="font-size20 font-weight-bold ">Upload employee excel file</span>
		</div>
							...
							<div class="input-group">
								...
								<div class="input-group-btn">
									<span class="fileUpload btn button-blue">
										...
										<input type="file" name="employeeFile" class="upload up" id="up" onchange="readURL(this);" />
									</span><!-- btn-orange -->
								</div><!-- btn -->
							</div><!-- group -->
						</div><!-- form-group -->
					...
					if (isset($count) && $count > 0) { ?>
						...
						if (isset($new) & count($new) > 0) { ?>
							<div class="col-12 mt-10 pl-20 pb-10 font-size16 font-weight-bold ">
								New Employee : <?= count($new) ?> records.
							...
							<div class="col-12 mt-10 pl-40 pb-10 font-size14">
								<div class="row">
									...
									foreach ($new as $n) : ?>
										...
										<div class="col-2"><?= $n["prefix"] ?></div>
										<div class="col-3"><?= $n["firstName"] ?></div>
										<div class="col-5"><?= $n["lastName"] ?></div>
									<?php
										$i++;
									endforeach;
									?>
						...
						if (isset($update) & count($update) > 0) { ?>
							<div class="col-12 mt-10 pl-20 pb-10 font-size16 font-weight-bold ">
								Update Employee : <?= count($update) ?> records.
							...
							<div class="col-12 mt-10 pl-40 pb-10 font-size14">
								<div class="row">
									...
									foreach ($update as $up) : ?>
										<div class="col-2"><?= $i ?></div>
										<div class="col-2"><?= $up["prefix"] ?></div>
										<div class="col-3"><?= $up["firstName"] ?></div>
										<div class="col-5"><?= $up["lastName"] ?></div>
									<?php
										$i++;
									endforeach;
									?>
