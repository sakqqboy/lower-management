            ...
            ?>
                <div class="row">
                    <div class="col-12 font-size18 amount-client-job">
                        ...
                        <a href="javascript:showRemark(<?= $client['clientId'] ?>)" class="button-red button-md no-underline" style="font-size:14px;padding:4px;">+ Remark</a>
                    ...
                    <div class="col-12 font-size14">
                        ...
                        <span id="show-remark-client"><?= $client["remark"] ?></span>
                    </div>
                    ...
                    <div class="col-6 font-size16 text-right mt-20">
                        <b>Yearly total fee :&nbsp;&nbsp;&nbsp;
                            ...
                            <?= isset($firstClient["currencyId"]) && $firstClient["currencyId"] != '' ? Currency::currencyCode($firstClient["currencyId"]) : '-' ?></b>
                    </div>
