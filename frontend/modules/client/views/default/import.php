...
<div class="body-content pt-20 container">
	<div class="row">
		<div class="col-12 mb-20 ">
			<span class="font-size20 font-weight-bold ">Upload client excel file</span>
		</div>
							...
							<div class="col-12 mt-10 pl-40 pb-10 font-size14">
								<div class="row">
									...
									foreach ($new as $n) : ?>
										...
										<div class="col-10"><?= $n["cleintName"] ?></div>
									<?php
										$i++;
									endforeach;
									?>
							...
							<div class="col-12 mt-10 pl-40 pb-10 font-size14">
								<div class="row">
									...
									foreach ($update as $up) : ?>
										<div class="col-2 mt-10"><?= $i ?></div>
										<div class="col-10 mt-10"><?= $up["cleintName"] ?></div>
									<?php
										$i++;
									endforeach;
									?>
